...
{
    public partial class InsertarCalificaciones : Form
    {
        public InsertarCalificaciones()
        {
            InitializeComponent();
        }
        private ListViewItem lastItemChecked; 

        private void InsertarCalificaciones_Load(object sender, EventArgs e)
        {
        ...
        private void ListViewTrimestres_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            ChildInsertarNota formNota = new ChildInsertarNota(indexEst, indexTrim);
            formNota.ShowDialog();
