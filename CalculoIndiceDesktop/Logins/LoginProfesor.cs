    ...
    public partial class LoginProfesor : Form
    {
        ...
        private void ButtonLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Select * from Login_Prof where username=@username and password=@password", con);
                ...
                {
                    this.Close();
                    MenuProfesor menuProf = new MenuProfesor(textBoxUsername.Text);
                    menuProf.Show();
                }
                else
                {
